...
@section('content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-info btn-md float-lg-right" data-toggle="modal" data-target="#createPermissionModal">
                                    <i class="fa fa-plus"> Create Permission</i>
                                </button>
                            </div>
                            ...
                            <div class="card-body">
                                <table id="all_roles" class="table table-bordered table-striped table-responsive-sm">
                                    ...
                                    @foreach ($permissions as $key => $permission)
                                        <tr id="roles_row{{$permission->id}}">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $permission->name }}</td>
                                            <td>{{ $permission->guard_name }}</td>
                                            <td align="center">
                                                <button type="button" class="btn btn-sm btn-success" onclick="editRoleModal({{$permission->id}});">Edit</button>
                                            </td>
                                            <td align="center">
                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteRole({{$permission->id}});">Delete</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
    ...
    <div class="modal fade show" id="createPermissionModal" tabindex="-1" role="dialog" aria-labelledby="createPermissionModalLabel" aria-modal="true">
